...
class _MenuScreenState extends State<MenuScreen> {
  void tapped(int index) {
    if (index == 0) {
      Navigator.of(context).push(NavIndexOne());
    } else if (index == 1) {
      ...
      child: Column(
        children: [
          Stack(
            ...
            children: [
              // custom app bar - repeat last order // help me choose
              ClipPath(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    // widget middle - repeat last order / help me choose?
                    SizedBox(height: 25),
                    Column(
                      children: [
                        Container(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(UniconsLine.map_marker, color: Colors.brown),
                          SizedBox(width: 10),
                          Text(
                            'Sushi',
                            style: GoogleFonts.poppins(
